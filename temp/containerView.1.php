...
//show student or course clicked on image in container view
        ...
        $valueIdTest = $_POST['picture'];
                $query = "SELECT * FROM `student` WHERE `id` = $valueIdTest";
                $res = mysqli_query($link,$query);
                while ($row=mysqli_fetch_array($res)){
                echo '<div><span><b>Id: </b>'.$row["id"]."</span><br><span><b>Name: </b>".$row["name"]."</span><br> <span><b>Phone: </b>".
        ...
        if( isset($_POST["course"])){
                ...
                $query = "SELECT * FROM `course` WHERE `id` = $valueIdTest";
                $res = mysqli_query($link,$query);
                while ($row=mysqli_fetch_array($res)){
                echo '<div><span><b>Course Id: </b>'.$row["id"]."</span><br><br>
...
<?php
// show add student modal when +student is pressed
